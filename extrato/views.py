...
def novo_valor(request):
    if request.method == "GET":
        ...
        valores = Valores( valor=valor,categoria_id=categoria,descricao=descricao, data=data, conta_id=conta,
tipo=tipo,
        )
...
def view_extrato(request):
   ...
   #TODO criar validacao para o periodo e criar um mencanismo de zerar os filtros ja selecionados ( um linl , butao etc)
